...
/**************************************************************************************************/
/** @fcn        bool rgb_lcd_on_vsync_event()
 *  @brief      VSYNC event callback function
 *  @details    x
 *
 *  @param    [in]  (esp_lcd_panel_handle_t) panel - descrip
 *  @param    [in]  (const esp_lcd_rgb_panel_event_data_t *) edata - descrip
 *  @param    [in]  (void *) user_ctx - descrip
 *
 *  @return   (bool) descrip
 */
/**************************************************************************************************/
...
/**************************************************************************************************/
/** @fcn        void waveshare_esp32_s3_touch_reset(void)
...
/**************************************************************************************************/
/** @fcn        esp_err_t waveshare_esp32_s3_rgb_lcd_init(void)
 *  @brief      Initialize RGB LCD
 *  @details    x
 *
 *  @return   (esp_err_t) descrip
 */
...
/**************************************************************************************************/
/** @fcn        esp_err_t waveshare_rgb_lcd_bl_on(void)
 *  @brief      x
 *  @details    x
 *
 *  @return   (esp_err_t) descrip
...
/**************************************************************************************************/
/** @fcn        esp_err_t waveshare_rgb_lcd_bl_off(void)
 *  @brief      x
 *  @details    x
 *
 *  @return   (esp_err_t) descrip
...
/**************************************************************************************************/
/** @fcn        void draw_event_cb(lv_event_t *e)
 *  @brief      Draw event callback function
 *  @details    x
 *
 *  @param    [in]  (lv_event_t *) e -  descrip
 */
/**************************************************************************************************/
...
/**************************************************************************************************/
/** @fcn        void add_data(lv_timer_t *timer)
 *  @brief      Timer callback to add data to the chart 
 *  @details    x
 *
 *  @param    [in]  (lv_timer_t *) timer - descrip
 */
/**************************************************************************************************/
...
/**************************************************************************************************/
/** @fcn        void example_lvgl_demo_ui(void)
 *  @brief      LVGL demo UI initialization function
 *  @details    This demo UI is adapted from LVGL official example
 *
 *  @url    https://docs.lvgl.io/master/examples.html#scatter-chart
 */
/**************************************************************************************************/
